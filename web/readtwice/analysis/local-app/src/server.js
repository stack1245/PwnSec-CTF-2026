...
app.get("/review", (req, res) => {
  console.log("[review]", req.query.rid, Boolean(currentReview), req.session.admin);
...
app.get("/sandbox", (req, res) => {
  console.log("[sandbox]", req.query.rid, Boolean(currentReview), req.session.admin);
  if (
    !reviewMatches(req)
    || !currentReview.prepared
    || !req.session.admin
...
app.get("/reports/check", (req, res) => {
  console.log("[check]", req.query.rid, req.get("sec-fetch-site"), req.get("sec-fetch-dest"), req.get("sec-purpose"), currentReview && { approved: currentReview.approved, finalized: currentReview.finalized, used: currentReview.used });
