...
const source = `<!doctype html><html><head><?start name=x><script>document.title='pwned'<\/script><?end><template patchfor=x><meta http-equiv="content-security-policy" content="default-src 'none'"></template></head><body><div></div></body></html>`;
